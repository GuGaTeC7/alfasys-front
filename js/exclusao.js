  ...
  fetch(`${host}/sciExclusao?page=${page}&size=${pageSize}`, {
    ...
    .then((dados) => {
      ...
      dados.content.forEach((item) => {
        ...
        const cadastroWorkflowDisabled =
          item.status !== "Em andamento" || item.cadastroWorkflow;
        ...
        const row = `
              <tr>
                ...
                ${
                  item.codExclusao
                    ...
                    : `<div class="input-icon-group">
                      <input type="text" class="form-control" id="codExclusao-${
                        item.endId
                ...
                <td>
                  <select class="form-select border-0 bg-light p-2" id="select-workflow-${
                    item.endId
                  }" 
...
document
  .querySelector("#sci-exclusão tbody")
...
function filtrarTabelaExclusao(
  page = 0,
  secao = "sci-exclusão",
  idTabela = "tabelaHistoricoExclusao"
) {
  const loadingOverlay = document.getElementById("loading-overlay");
        ...
        ${
          item.codExclusao
            ...
            : `<div class="input-icon-group">
                ...
                <i class="fa-sharp-duotone fa-solid fa-square-arrow-up-right btnEnviarCodExclusao" data-id="${
                  item.endId
                }"></i>
              </div>`
        }
...
document
  ...
  .addEventListener("change", (event) => {
    ...
    if (
      ...
      target.id.startsWith("select-workflow-")
    ) {
