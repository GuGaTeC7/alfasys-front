      ...
      dados.content.forEach((item) => {
        ...
        const row = `
            <tr>
                ...
                ${
                  dataRealizacao
                    ? `<input 
                        ...
                        disabled
                        id="data-readata-realizacao-${item.endId}"
                      />`
                    : renderInputDate(
              ...
              <td>
                <select class="form-select border-0 bg-light p-2">
...
const historicoLinkVistoria = document.querySelector(
    "a[href='#vistoria']"
  );
